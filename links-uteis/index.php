...
<body style="background-color: #0f0f0f; height: 100%">
  ...
  <!-- SOCIAL MEDIA -->
	<div id="links-uteis" class="container-fluid">
      ...
      <img src="../assets/img/header/logo.png" style="width: 100px; height: 30px; margin-top: 30px; margin-bottom: 10px; opacity: 0.4" alt="logo BuildLab">
		</div>
		...
		<div class="row">
			<div class="col-12 col-sm-6 col-md-12 d-flex flex-md-row flex-column justify-content-center align-items-center">
				...
				<a href="https://buildlab.com.br" target="_blank">
					<div class="icone-social">
            <i class="fas fa-globe-americas"></i>
						<h4 class="title">Website</h4>
					</div>
				</a>
				<a href="https://blog.buildlab.com.br" target="_blank">
					<div class="icone-social">
