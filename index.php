...
<body id="page-top" data-spy="scroll" data-target=".fixed-top">
	...
	<nav class="navbar navbar-expand-lg navbar-custom fixed-top" role="navigation">
		<div class="container">
			<a class="navbar-brand page-scroll" href="#page-top">
				<img src="assets/img/header/logo.png" class="img-logo" alt="logo BuildLab">
			</a>
		...
		<div class="container ">
			<div class="row ">
				<div class="col-sm-12 col-md-6 ">
					<h6>BUILD LAB</h6>
					<p class="text-justify">Conecte-se ao nosso mundo!</p>
				</div>
	...
	<!-- TypeWriter JS -->
	<script type="text/javascript" src="assets/js/lib/typed.min.js"></script>
